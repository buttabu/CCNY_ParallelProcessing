...
#define nx 6000		//Resolution in the X dimention
#define ny 6000		//Resolution in the Y dimention

int maxiter= 1000;			//max number of iterations to test for an escaping point
int myRank;
int commSize;
